    ...
    // })
      ...
      .then((res)=>{
        ...
        if(resp.message=="well match")
        {
            ...
            //  localStorage.setItem('user',JSON.stringify({isLognin:true}));
            // console.log(resp.userinfo[0].id);
            // Navigate("/"+resp.userinfo[0].id);
            // window.localStorage.setItem('banner',true);
            localStorage.setItem('users',JSON.stringify({id:resp.userinfo[0].id,username:resp.userinfo[0].username,isLognin:true}));
            Navigate("/");
          }
    }).catch((err)=>{
        console.log(err.message);
            ...
            <div className="col-md-4 col-lg-4   ones">
                ...
                <div className="row text-center mb-4 votcard shadow-md bg-white p-4 pt-5 ">
                    ...
                    <div className="col-md-12 col-lg-12 profile">
                      ...
                      <div className="row">
                            <div className="col-md-12">  <h4 className="bg-info text-white caption"> STUDENT LOGIN </h4></div>
                ...
                <div className="row">
                            ...
                            <div className="col-md-6"><Link to="/admin" className="text-decoration-none"> <h4 className="bg-info text-white caption"> ADMIN </h4></Link></div>
                        </div>
